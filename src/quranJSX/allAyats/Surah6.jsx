...
const Surah6 = () => {
  ...
  const isActive = useMatch(`/Surah6`);
  ...
  return (
    ...
    <div dir='rtl' className='surah1MainDiv'>
      ...
      <div className="AllAboutSurahNames">
          ...
          <Link className='insideSurahnems isActive' to="/Surah6"><div><p className='p2'>۶</p></div><p className='p'>سُوْرَةُ الأنْعَام</p></Link>
      ...
      <div className='AllAboutSurah'>
          <div className='surahNameAndBismillah'>
              <h2 className='text-center pb-2'>سُوْرَةُ الأنْعَام</h2>
              <h2 className='text-center'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ</h2>
          </div>
          
          {Allsurah.Surah6.map((value)=> {
