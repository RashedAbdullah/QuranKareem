...
const Surah114 = () => {
  ...
  const isActive = useMatch(`/Surah114`);
  ...
  return (
    ...
    <div dir='rtl' className='surah1MainDiv'>
      ...
      <div className="AllAboutSurahNames">
          ...
          <Link className='insideSurahnems isActive' to="/Surah114"><div><p className='p2'>۱۱۴</p></div><p className='p'>سُوْرَةُ النَّاس</p></Link>

      </div>

      <div className='AllAboutSurah'>
          <div className='surahNameAndBismillah'>
              <h2 className='text-center pb-2'>سُوْرَةُ النَّاس</h2>
              <h2 className='text-center'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ</h2>
          </div>
          
          {Allsurah.Surah114.map((value)=> {
