...
const Surah32 = () => {
  ...
  const isActive = useMatch(`/Surah32`);
  ...
  return (
    ...
    <div dir='rtl' className='surah1MainDiv'>
      ...
      <div className="AllAboutSurahNames">
          ...
          <Link className='insideSurahnems isActive' to="/Surah32"><div><p className='p2'>۳۲</p></div><p className='p'>سُوْرَةُ السَّجْدَة</p></Link>
      ...
      <div className='AllAboutSurah'>
          <div className='surahNameAndBismillah'>
              <h2 className='text-center pb-2'>سُوْرَةُ السَّجْدَة</h2>
              <h2 className='text-center'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ</h2>
          </div>
          
          {Allsurah.Surah32.map((value)=> {
