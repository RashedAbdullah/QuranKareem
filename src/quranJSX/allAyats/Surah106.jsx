...
const Surah106 = () => {
  ...
  const isActive = useMatch(`/Surah106`);
  ...
  return (
    ...
    <div dir='rtl' className='surah1MainDiv'>
      ...
      <div className="AllAboutSurahNames">
          ...
          <Link className='insideSurahnems isActive' to="/Surah106"><div><p className='p2'>۱۰۶</p></div><p className='p'>سُوْرَةُ قُرَيْش</p></Link>
      ...
      <div className='AllAboutSurah'>
          <div className='surahNameAndBismillah'>
              <h2 className='text-center pb-2'>سُوْرَةُ قُرَيْش</h2>
              <h2 className='text-center'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ</h2>
          </div>
          
          {Allsurah.Surah106.map((value)=> {
