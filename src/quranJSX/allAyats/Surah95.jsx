...
const Surah95 = () => {
  ...
  const isActive = useMatch(`/Surah95`);
  ...
  return (
    ...
    <div dir='rtl' className='surah1MainDiv'>
      ...
      <div className="AllAboutSurahNames">
          ...
          <Link className='insideSurahnems isActive' to="/Surah95"><div><p className='p2'>۹۵</p></div><p className='p'>سُوْرَةُ التِّين</p></Link>
      ...
      <div className='AllAboutSurah'>
          <div className='surahNameAndBismillah'>
              <h2 className='text-center pb-2'>سُوْرَةُ التِّين</h2>
              <h2 className='text-center'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ</h2>
          </div>
          
          {Allsurah.Surah95.map((value)=> {
