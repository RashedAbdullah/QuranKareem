...
const Surah98 = () => {
  ...
  const isActive = useMatch(`/Surah98`);
  ...
  return (
    ...
    <div dir='rtl' className='surah1MainDiv'>
      ...
      <div className="AllAboutSurahNames">
          ...
          <Link className='insideSurahnems' to="/Surah69"><div><p className='p2'>۶۹</p></div><p className='p'>سُوْرَةُ الحَاقَّة</p></Link>
          ...
          <Link className='insideSurahnems isActive' to="/Surah90"><div><p className='p2'>۹۰</p></div><p className='p'>سُوْرَةُ البَلَد</p></Link>
          ...
          <Link className='insideSurahnems isActive' to="/Surah98"><div><p className='p2'>۹۸</p></div><p className='p'>سُوْرَةُ البَيِّنَة</p></Link>
      ...
      <div className='AllAboutSurah'>
          <div className='surahNameAndBismillah'>
              <h2 className='text-center pb-2'>سُوْرَةُ البَيِّنَة</h2>
              <h2 className='text-center'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ</h2>
          </div>
          
          {Allsurah.Surah98.map((value)=> {
