...
const Surah52 = () => {
  ...
  const isActive = useMatch(`/Surah52`);
  ...
  return (
    ...
    <div dir='rtl' className='surah1MainDiv'>
      ...
      <div className="AllAboutSurahNames">
          ...
          <Link className='insideSurahnems isActive' to="/Surah52"><div><p className='p2'>۵۲</p></div><p className='p'>سُوْرَةُ الطُّور</p></Link>
      ...
      <div className='AllAboutSurah'>
          <div className='surahNameAndBismillah'>
              <h2 className='text-center pb-2'>سُوْرَةُ الطُّور</h2>
              <h2 className='text-center'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ</h2>
          </div>
          
          {Allsurah.Surah52.map((value)=> {
